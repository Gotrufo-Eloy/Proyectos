...
-- 1. Obtener los títulos de todos los programas junto con el nombre del canal en el que se transmiten.

-- 2. Listar todos los programas con su categoría correspondiente.

-- 3. Mostrar los presentadores y los programas que conducen.

-- 4. Obtener todos los programas y sus emisiones, incluyendo aquellos que aún no han sido transmitidos.
